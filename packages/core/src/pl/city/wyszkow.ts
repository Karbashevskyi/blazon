...
/**
 * Herb Wyszków — Polish coat of arms (Wyszków)
 * @id pl-city-wyszkow
 */
const wyszkow: CoatOfArms = {
  id: 'pl-city-wyszkow',
  name: 'Herb Wyszków',
  description: 'Coat of arms of Wyszków (Herb Wyszków), a city in Poland.',
  ...
  license: {
    ...
    source: 'https://commons.wikimedia.org/wiki/File:POL%20Wyszk%C3%B3w%20COA.svg',
  },
  tags: ['poland', 'wyszkow', 'city'],
} as const;
