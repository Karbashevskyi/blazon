...
/**
 * Herb Blachownia — Polish coat of arms (Blachownia)
 * @id pl-city-blachownia
 */
const blachownia: CoatOfArms = {
  id: 'pl-city-blachownia',
  name: 'Herb Blachownia',
  description: 'Coat of arms of Blachownia (Herb Blachownia), a city in Poland.',
  ...
  license: {
    ...
    source: 'https://commons.wikimedia.org/wiki/File:POL%20Blachownia%20COA.svg',
  },
  tags: ['poland', 'blachownia', 'city'],
} as const;
