...
/**
 * Herb Szczebrzeszyn — Polish coat of arms (Szczebrzeszyn)
 * @id pl-city-szczebrzeszyn
 */
const szczebrzeszyn: CoatOfArms = {
  id: 'pl-city-szczebrzeszyn',
  name: 'Herb Szczebrzeszyn',
  description: 'Coat of arms of Szczebrzeszyn (Herb Szczebrzeszyn), a city in Poland.',
  ...
  license: {
    ...
    source: 'https://commons.wikimedia.org/wiki/File:POL%20Szczebrzeszyn%20COA.svg',
  },
  tags: ['poland', 'szczebrzeszyn', 'city'],
} as const;

export { szczebrzeszyn };
