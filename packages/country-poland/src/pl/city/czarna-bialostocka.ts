...
/**
 * Herb Czarna Białostocka — Polish coat of arms (Czarna Białostocka)
 * @id pl-city-czarna-bialostocka
 */
const czarnaBialostocka: CoatOfArms = {
  id: 'pl-city-czarna-bialostocka',
  name: 'Herb Czarna Białostocka',
  description: 'Coat of arms of Czarna Białostocka (Herb Czarna Białostocka), a city in Poland.',
  ...
  license: {
    ...
    source: 'https://commons.wikimedia.org/wiki/File:POL%20Czarna%20Bia%C5%82ostocka%20COA.svg',
  },
  tags: ['poland', 'czarna-bialostocka', 'city'],
} as const;

export { czarnaBialostocka };
