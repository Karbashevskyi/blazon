...
/**
 * Herb Stryków — Polish coat of arms (Stryków)
 * @id pl-city-strykow
 */
const strykow: CoatOfArms = {
  id: 'pl-city-strykow',
  name: 'Herb Stryków',
  description: 'Coat of arms of Stryków (Herb Stryków), a city in Poland.',
  ...
  license: {
    ...
    source: 'https://commons.wikimedia.org/wiki/File:POL%20Stryk%C3%B3w%20COA.svg',
  },
  tags: ['poland', 'strykow', 'city'],
} as const;
