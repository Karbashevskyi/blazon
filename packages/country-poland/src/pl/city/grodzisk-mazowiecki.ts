...
/**
 * Herb Grodzisk Mazowiecki — Polish coat of arms (Grodzisk Mazowiecki)
 * @id pl-city-grodzisk-mazowiecki
 */
const grodziskMazowiecki: CoatOfArms = {
  id: 'pl-city-grodzisk-mazowiecki',
  name: 'Herb Grodzisk Mazowiecki',
  description: 'Coat of arms of Grodzisk Mazowiecki (Herb Grodzisk Mazowiecki), a city in Poland.',
  ...
  license: {
    ...
    source: 'https://commons.wikimedia.org/wiki/File:POL%20Grodzisk%20Mazowiecki%20COA.svg',
  },
  tags: ['poland', 'grodzisk-mazowiecki', 'city'],
} as const;

export { grodziskMazowiecki };
