...
/**
 * Herb Lesko — Polish coat of arms (Lesko)
 * @id pl-city-lesko
 */
const lesko: CoatOfArms = {
  id: 'pl-city-lesko',
  name: 'Herb Lesko',
  description: 'Coat of arms of Lesko (Herb Lesko), a city in Poland.',
  ...
  license: {
    ...
    source: 'https://commons.wikimedia.org/wiki/File:POL%20Lesko%20COA.svg',
  },
  tags: ['poland', 'lesko', 'city'],
} as const;
