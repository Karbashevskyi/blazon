...
/**
 * Herb Mogilno — Polish coat of arms (Mogilno)
 * @id pl-city-mogilno
 */
const mogilno: CoatOfArms = {
  id: 'pl-city-mogilno',
  name: 'Herb Mogilno',
  description: 'Coat of arms of Mogilno (Herb Mogilno), a city in Poland.',
  ...
  license: {
    ...
    source: 'https://commons.wikimedia.org/wiki/File:POL%20Mogilno%20COA%20old.svg',
  },
  tags: ['poland', 'mogilno', 'city'],
} as const;
