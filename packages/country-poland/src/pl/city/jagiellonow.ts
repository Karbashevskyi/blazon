...
/**
 * Herb Jagiellonów — Polish coat of arms (Jagiellonów)
 * @id pl-city-jagiellonow
 */
const jagiellonow: CoatOfArms = {
  id: 'pl-city-jagiellonow',
  name: 'Herb Jagiellonów',
  description: 'Coat of arms of Jagiellonów (Herb Jagiellonów), a city in Poland.',
  ...
  license: {
    ...
    source: 'https://commons.wikimedia.org/wiki/File:POL%20Jagiellon%C3%B3w%20COA.svg',
  },
  tags: ['poland', 'jagiellonow', 'city'],
} as const;
