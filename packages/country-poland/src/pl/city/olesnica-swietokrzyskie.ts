...
/**
 * Herb Oleśnica (świętokrzyskie) — Polish coat of arms (Oleśnica (świętokrzyskie))
 * @id pl-city-olesnica-swietokrzyskie
 */
const olesnicaSwietokrzyskie: CoatOfArms = {
  id: 'pl-city-olesnica-swietokrzyskie',
  name: 'Herb Oleśnica (świętokrzyskie)',
  description:
    'Coat of arms of Oleśnica (świętokrzyskie) (Herb Oleśnica (świętokrzyskie)), a city in Poland.',
  ...
  license: {
    ...
    source:
      'https://commons.wikimedia.org/wiki/File:POL%20Ole%C5%9Bnica%20%28%C5%9Bwi%C4%99tokrzyskie%29%20COA.svg',
  },
  tags: ['poland', 'olesnica-swietokrzyskie', 'city'],
} as const;

export { olesnicaSwietokrzyskie };
