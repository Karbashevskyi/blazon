...
/**
 * Herb Izbica — Polish locality
 * @id pl-city-izbica
 */
const plIzbica: BlazonLocality = {
  id: 'pl-city-izbica',
  name: 'Herb Izbica',
  countryCode: 'PL',
  kind: 'city',
  region: 'Poland',
  aliases: ['poland', 'izbica', 'city'],
  assets: [
    {
      kind: 'arms',
  ...
  sources: [{ url: 'https://commons.wikimedia.org/wiki/File:POL%20Izbica%20COA.svg' }],
};
