...
/**
 * Herb Żabno — Polish locality
 * @id pl-city-zabno
 */
const plZabno: BlazonLocality = {
  id: 'pl-city-zabno',
  name: 'Herb Żabno',
  countryCode: 'PL',
  kind: 'city',
  region: 'Poland',
  aliases: ['poland', 'zabno', 'city'],
  assets: [
    {
      kind: 'arms',
  ...
  sources: [{ url: 'https://commons.wikimedia.org/wiki/File:POL%20%C5%BBabno%20COA.svg' }],
};
