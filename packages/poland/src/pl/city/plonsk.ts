...
/**
 * Herb Płońsk — Polish locality
 * @id pl-city-plonsk
 */
const plPlonsk: BlazonLocality = {
  id: 'pl-city-plonsk',
  name: 'Herb Płońsk',
  countryCode: 'PL',
  kind: 'city',
  region: 'Poland',
  aliases: ['poland', 'plonsk', 'city'],
  assets: [
    {
      kind: 'arms',
  ...
  sources: [
    {
      url: 'https://commons.wikimedia.org/wiki/File:POL%20P%C5%82o%C5%84sk%20COA%20%28do%202012%29.svg',
    },
  ],
};
