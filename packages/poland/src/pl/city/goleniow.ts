...
/**
 * Herb Goleniów — Polish locality
 * @id pl-city-goleniow
 */
const plGoleniow: BlazonLocality = {
  id: 'pl-city-goleniow',
  name: 'Herb Goleniów',
  countryCode: 'PL',
  kind: 'city',
  region: 'Poland',
  aliases: ['poland', 'goleniow', 'city'],
  assets: [
    {
      kind: 'arms',
  ...
  sources: [{ url: 'https://commons.wikimedia.org/wiki/File:POL%20Goleni%C3%B3w%20COA.svg' }],
};
