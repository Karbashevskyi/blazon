...
/**
 * Herb Chełmno — Polish locality
 * @id pl-city-chelmno
 */
const plChelmno: BlazonLocality = {
  id: 'pl-city-chelmno',
  name: 'Herb Chełmno',
  countryCode: 'PL',
  kind: 'city',
  region: 'Poland',
  aliases: ['poland', 'chelmno', 'city'],
  assets: [
    {
      kind: 'arms',
  ...
  sources: [
    {
      url: 'https://commons.wikimedia.org/wiki/File:POL%20Che%C5%82mno%20COA%20%28do%202000%29.svg',
    },
  ],
};
