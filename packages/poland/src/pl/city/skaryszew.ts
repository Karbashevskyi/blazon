...
/**
 * Herb Skaryszew — Polish locality
 * @id pl-city-skaryszew
 */
const plSkaryszew: BlazonLocality = {
  id: 'pl-city-skaryszew',
  name: 'Herb Skaryszew',
  countryCode: 'PL',
  kind: 'city',
  region: 'Poland',
  aliases: ['poland', 'skaryszew', 'city'],
  assets: [
    {
      kind: 'arms',
  ...
  sources: [{ url: 'https://commons.wikimedia.org/wiki/File:POL%20Skaryszew%20COA.svg' }],
};
