...
/**
 * Herb Lubaczów — Polish locality
 * @id pl-city-lubaczow
 */
const plLubaczow: BlazonLocality = {
  id: 'pl-city-lubaczow',
  name: 'Herb Lubaczów',
  countryCode: 'PL',
  kind: 'city',
  region: 'Poland',
  aliases: ['poland', 'lubaczow', 'city'],
  assets: [
    {
      kind: 'arms',
  ...
  sources: [{ url: 'https://commons.wikimedia.org/wiki/File:POL%20Lubacz%C3%B3w%20COA.svg' }],
};
