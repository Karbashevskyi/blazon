...
/**
 * Herb Miejsce Piastowe — Polish locality
 * @id pl-city-miejsce-piastowe
 */
const plMiejscePiastowe: BlazonLocality = {
  id: 'pl-city-miejsce-piastowe',
  name: 'Herb Miejsce Piastowe',
  countryCode: 'PL',
  kind: 'city',
  region: 'Poland',
  aliases: ['poland', 'miejsce-piastowe', 'city'],
  assets: [
    {
      kind: 'arms',
  ...
  sources: [{ url: 'https://commons.wikimedia.org/wiki/File:POL%20Miejsce%20Piastowe%20COA.svg' }],
};

export { plMiejscePiastowe };
