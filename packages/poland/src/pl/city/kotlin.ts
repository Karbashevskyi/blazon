...
/**
 * Herb Kotlin — Polish locality
 * @id pl-city-kotlin
 */
const plKotlin: BlazonLocality = {
  id: 'pl-city-kotlin',
  name: 'Herb Kotlin',
  countryCode: 'PL',
  kind: 'city',
  region: 'Poland',
  aliases: ['poland', 'kotlin', 'city'],
  assets: [
    {
      kind: 'arms',
  ...
  sources: [{ url: 'https://commons.wikimedia.org/wiki/File:POL%20Kotlin%20COA.svg' }],
};
