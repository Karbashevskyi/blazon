...
/**
 * Herb Krynica Morska — Polish locality
 * @id pl-city-krynica-morska
 */
const plKrynicaMorska: BlazonLocality = {
  id: 'pl-city-krynica-morska',
  name: 'Herb Krynica Morska',
  countryCode: 'PL',
  kind: 'city',
  region: 'Poland',
  aliases: ['poland', 'krynica-morska', 'city'],
  assets: [
    {
      kind: 'arms',
  ...
  sources: [{ url: 'https://commons.wikimedia.org/wiki/File:POL%20Krynica%20Morska%20COA.svg' }],
};

export { plKrynicaMorska };
